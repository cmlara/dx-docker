...
$conf['s3fs_bucket'] = getenv('S3FS_BUCKET');
$conf['s3fs_region'] = getenv('S3FS_REGION');
$conf['s3fs_use_cname'] = FALSE;
$conf['s3fs_domain'] = getenv('S3FS_DOMAIN');
$conf['s3fs_domain_root'] = 'none'; # , 'root', 'public', or 'root_public';
$conf['s3fs_domain_s3_private'] = FALSE;
$conf['s3fs_use_customhost'] = FALSE;
$conf['s3fs_hostname'] = getenv('S3FS_HOSTNAME');
$conf['s3fs_use_versioning'] = FALSE;
...
$conf['awssdk2_access_key'] = getenv('S3FS_AWS_ACCESS_KEY');
$conf['awssdk2_secret_key'] = getenv('S3FS_AWS_SECRET_KEY');
$conf['awssdk2_use_instance_profile'] = FALSE;
