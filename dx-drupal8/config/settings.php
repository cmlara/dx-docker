...
$config['s3fs.settings']['use_https'] = strcmp(getenv('S3FS_USE_HTTPS'), 'TRUE') === 0;
$config['s3fs.settings']['use_path_style_endpoint'] = strcmp(getenv('S3FS_USE_PATH_STYLE_ENDPOINT'), 'TRUE') === 0;
$settings['s3fs.use_s3_for_public'] = TRUE;
$settings['s3fs.use_s3_for_private'] = TRUE;
$settings['s3fs.access_key'] = getenv('S3FS_AWS_ACCESS_KEY');
$settings['s3fs.secret_key'] = getenv('S3FS_AWS_SECRET_KEY');

// Working config from Drupal 7
// $conf['s3fs_bucket'] = 'acqit-prod-data';
// $conf['s3fs_use_cname'] = FALSE;
// $conf['s3fs_use_customhost'] = FALSE;
// $conf['s3fs_hostname'] = '';
// $conf['s3fs_cache_control_header'] = 'public, max-age=300';
// $conf['awssdk2_default_cache_config'] = '/tmp';
